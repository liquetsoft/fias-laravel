...
use Liquetsoft\Fias\Laravel\LiquetsoftFiasBundle\Resource\Steads as Resource;
use Liquetsoft\Fias\Laravel\LiquetsoftFiasBundle\Tests\BaseCase;

/**
 * Тест ресурса для сущности 'Steads'.
 *
 * @internal
 */
class SteadsTest extends BaseCase
{
    /**
    ...
    public function testToArray(): void
    {
        ...
        $model->opertypeid = $this->createFakeData()->word();
