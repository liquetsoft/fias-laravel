 ...
 * @internal
 */
final class ApartmentsTest extends BaseCase
{
    /**
    ...
    public function testToArray(): void
    {
        ...
        $model->aparttype = $this->createFakeData()->numberBetween(1, 1000000);
        ...
        $this->assertArrayHasKey('aparttype', $array);
        $this->assertSame($model->aparttype, $array['aparttype']);
