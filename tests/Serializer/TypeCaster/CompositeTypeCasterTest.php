...
use Liquetsoft\Fias\Laravel\LiquetsoftFiasBundle\Serializer\TypeCaster\CompositeTypeCaster;
 ...
 * @internal
 */
final class CompositeTypeCasterTest extends BaseCase
{
    /**
    ...
    public function testCanCast(): void
    {
        ...
        $caster = new CompositeTypeCaster([$caster1, $caster2]);
