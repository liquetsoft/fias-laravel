...
class FiasLaravelOperationStatus extends Migration
{
    ...
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_operation_status');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_operation_status', function (Blueprint $table): void {
