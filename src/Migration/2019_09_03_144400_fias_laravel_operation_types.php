...
class Fiaslaraveloperationtypes extends Migration
{
    ...
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_operation_types');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_operation_types', function (Blueprint $table): void {
