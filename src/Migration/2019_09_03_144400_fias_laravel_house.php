...
class FiasLaravelHouse extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fias_laravel_house', function (Blueprint $table) {
            ...
            $table->string('housenum', 20)->nullable(true);
            ...
            $table->string('ifnsfl', 4)->nullable(true);
            $table->string('ifnsul', 4)->nullable(true);
            $table->string('okato', 11)->nullable(true);
            $table->string('oktmo', 11)->nullable(true);
