...
/**
 * Миграция для создания сущности 'ROOMS'.
 */
class Fiaslaravelrooms extends Migration
{
    /**
     * Создание таблицы 'fias_laravel_rooms'.
     */
    public function up(): void
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_rooms');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_rooms', function (Blueprint $table): void {
            ...
            $table->string('number', 50)->nullable(false)->comment('Номер комнаты или офиса');
            $table->unsignedInteger('roomtype')->nullable(false)->comment('Тип комнаты или офиса');
    ...
    /**
     * Удаление таблицы 'fias_laravel_rooms'.
     */
