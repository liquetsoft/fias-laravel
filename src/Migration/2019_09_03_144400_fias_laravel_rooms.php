 ...
 */
final class Fiaslaravelrooms extends Migration
{
    /**
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->dropIfExists('fias_laravel_rooms');
        Schema::connection($connectionName)->create('fias_laravel_rooms', function (Blueprint $table): void {
