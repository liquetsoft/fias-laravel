...
/**
 * Миграция для создания сущности 'HOUSE_TYPES'.
 */
class Fiaslaravelhousetypes extends Migration
{
    /**
     * Создание таблицы 'fias_laravel_house_types'.
     */
    public function up(): void
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_house_types');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_house_types', function (Blueprint $table): void {
            // создание полей таблицы
            $table->unsignedInteger('id')->nullable(false)->comment('Идентификатор')->primary();
    ...
    /**
     * Удаление таблицы 'fias_laravel_house_types'.
     */
