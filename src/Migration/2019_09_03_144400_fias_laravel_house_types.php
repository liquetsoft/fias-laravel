 ...
 */
final class Fiaslaravelhousetypes extends Migration
{
    /**
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->dropIfExists('fias_laravel_house_types');
        Schema::connection($connectionName)->create('fias_laravel_house_types', function (Blueprint $table): void {
