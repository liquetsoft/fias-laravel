...
class Fiaslaravelapartmenttypes extends Migration
{
    ...
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_apartment_types');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_apartment_types', function (Blueprint $table): void {
