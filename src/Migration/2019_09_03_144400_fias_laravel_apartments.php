...
/**
 * Миграция для создания сущности 'APARTMENTS'.
 */
final class Fiaslaravelapartments extends Migration
{
    /**
     * Создание таблицы 'fias_laravel_apartments'.
     */
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('fias_laravel_apartments', function (Blueprint $table): void {
            ...
            $table->string('number', 50)->nullable(false)->comment('Номер комнаты');
            $table->unsignedInteger('aparttype')->nullable(false)->comment('Тип комнаты');
    ...
    /**
     * Удаление таблицы 'fias_laravel_apartments'.
     */
