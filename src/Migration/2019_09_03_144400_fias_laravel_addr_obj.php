...
class Fiaslaraveladdrobj extends Migration
{
    ...
    {
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->dropIfExists('fias_laravel_addr_obj');
        Schema::connection(config('liquetsoft_fias.eloquent_connection'))->create('fias_laravel_addr_obj', function (Blueprint $table): void {
