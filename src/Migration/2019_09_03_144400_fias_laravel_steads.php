 ...
 */
final class Fiaslaravelsteads extends Migration
{
    /**
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->dropIfExists('fias_laravel_steads');
        Schema::connection($connectionName)->create('fias_laravel_steads', function (Blueprint $table): void {
